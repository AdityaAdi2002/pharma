...
<body>
	...
	<div id="nav_bar">
		<div class="cart">
			<a href="" class="cart"><img src="../image/cart2.png" alt="cart"
				width="25em" height="25em" style="border-radius: 5em;"> </a>
		</div>
		<div class="admin">
			<a href="./logadmin.html" class="admin"
	...
	<section class="parent1">
		...
		<div id="child2">
			...
			%>
			<div class="cart">
				<a href="/jsp/AddToCart.jsp" class="cart"><img
